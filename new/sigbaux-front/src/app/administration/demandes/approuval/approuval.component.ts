...
@Component({
  selector: 'app-approuval',
  templateUrl: './approuval.component.html',
  providers: [MessageService, ConfirmationService]
})
export class ApprouvalComponent {
  ...
  validateRequest() {
    this.requestService.changeRequestStatus('held',this.request.id).subscribe(() => {
      this.requestService.getRequestsByStatus("APPROVAL").subscribe(data => (this.requests = data));
