...
export class ValidationConseilComponent implements OnInit {
  requests: Request[] = [];
  ...
  ngOnInit() {
    ...
    this.cols = [
      ...
      { field: 'motivationRequest', header: 'Motivation' },
      { field: 'structureCurrentPosition', header: 'Current Position' },
      { field: 'agentsNumber', header: 'Agents' },
      { field: 'managersNumber', header: 'Managers' },
      { field: 'desiredGeographicalLocation', header: 'Location' },
      { field: 'leasePortfolioMinistry', header: 'Ministry' },
      { field: 'buildingsOccupancyStatus', header: 'Occupancy Status' }
    ];
  }
