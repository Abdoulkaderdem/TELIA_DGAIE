...
export class RentalRequestService {
  ...
  submitRentalRequest(rentalRequest: RentalRequest): Observable<any> {
    //return this.http.post<any>(this.apiUrl, rentalRequest);
    return this.http.post<DataResponse<RentalRequest>>(this.get_url('create'), rentalRequest, {
      headers: new HttpHeaders({ 'Content-Type': 'application/json' })
    });
  }
}